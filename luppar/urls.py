...
from search_engine.views import IndexView, SearchView, DocumentView, AboutView, ResultView, DocView, DownloadsView, \
    RecomView, SearchRecommView, ConfigView

if DEBUG:
    urlpatterns = [
        url(r'^$', IndexView.as_view(), name='index'),
        url(r'^about$', AboutView.as_view(), name='about'),
        url(r'^recommender', RecomView.as_view(), name='recommender'),
        ...
        url(r'^search_recomm$', SearchRecommView.as_view(), name='search_recomm'),
        url(r'^query_preview$', views.query_preview, name='query_preview'),
        url(r'^crawler_pages$', views.crawler_pages, name='crawler_pages$'),
