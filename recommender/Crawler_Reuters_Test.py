...
def download_news_page():
    ...
    pickle.dump(X, open(os.path.join(data_dir,'reuters_X_Test_pp_new_1d_on.ipy'), 'wb'), pickle.HIGHEST_PROTOCOL)
    pickle.dump(y, open(os.path.join(data_dir,'reuters_y_Test_pp_new_1d_on.ipy'), 'wb'), pickle.HIGHEST_PROTOCOL)
    pickle.dump(z, open(os.path.join(data_dir,'reuters_z_Test_pp_new_1d_on.ipy'), 'wb'), pickle.HIGHEST_PROTOCOL)
